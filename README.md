...
Since summer 2025 we have experimented with AI tools such as ChatGPT and Claude when implementing further scripts/modules. This approach turned out to be very 
useful, though requiring thorough checks and test. Many preexisting pieces of code was cleaned, commented, and sometimes reorganized by claude. In perucular, the 
included readme files were generated by claude. A note concerning AI (co)authorship has been added to the docstrings and readmes. 
 

# References

_[1] M. Deal, G. Nolet (1996) “Nullspace shuttles", Geophysical Journal International, 124, 372–380,doi:10.1111/j.1365-246X.1996.tb07027.x_

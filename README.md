...
useful, though requiring thorough checks and test. In particular, the included readme files were generated by claude. A note concerning AI (co)authorship has been 
added to the docstrings. Parts of these scripts have found their way into the modules later, keeping the docstrings.

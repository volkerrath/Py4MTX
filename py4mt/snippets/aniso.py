...
def aniso_fwd(parvec=None, **kwargs): #nl=None, hl=None, per=None):
    '''
    Wrapper for mcmc runs

    Parameters
    ----------
    parvec : np.array
        parameter vector for inversion. The default is None.
    **kwargs : dict
        keyword arguments passed tp z1anis

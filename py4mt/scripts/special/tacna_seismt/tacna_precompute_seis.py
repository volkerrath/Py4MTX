...
# in tacna_plot_seis.py (PROFILE_CD_LON/LAT etc.) — the two are defined
# independently and can silently drift apart. profile_CD's endpoints,
# [-70.476, -18.255] and [-69.499, -17.048], both fell *outside* the box
# previously used here (copied from an earlier, narrower revision), leaving
# no velocity data at all near either end of the profile — a white gap at
# both edges of the section, not related to topography or masking. Widened
...
print(f"  Actual depth range in source model: "

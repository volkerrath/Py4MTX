...
| 2026-08-13 | Claude Sonnet 5 (Anthropic) | Added `femtic_rto_prior_summary.md` output at end of run: user-set (UPPERCASE) parameters, script path, and run date/time. |

...
| `QC_SLICES` | 4 slices | Slice-spec list in model-local metres — same format as `femtic_mod_plot.PLOT_SLICES`; kinds: `"map"`, `"ns"`, `"ew"`, `"plane"`; optional `invert_x=True` per panel flips horizontal axis on curtain/plane panels |

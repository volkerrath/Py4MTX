...
# -*- coding: utf-8 -*-
"""
Script-style driver for transdimensional (rjMCMC) anisotropic 1-D MT inversion.
...
Likelihood modes
----------------
This anisotropic driver is restricted to the anisotropic likelihoods:

- ``"Z_comps"`` — Re/Im of selected Z components, optionally plus PT
- ``"rhoa"`` — legacy/fallback apparent-resistivity likelihood
...
if likelihood_mode.lower() not in {"z_comps", "rhoa"}:
    raise ValueError("Anisotropic driver supports only likelihood_mode='Z_comps' or 'rhoa'.")

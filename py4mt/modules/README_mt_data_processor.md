# mt_data_processor.py — Batch MT station processing script

`mt_data_processor.py` is a top-level processing script that reads a directory
of EDI files, applies a configurable chain of operations, and exports results
in multiple formats.
